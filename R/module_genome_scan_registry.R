...
#' Weir-Cockerham global FST and windowed diversity, tracked along physical
#' position rather than only as a single genome-wide summary, while
#' preserving the existing runner, result schema, and population-metadata
#' requirements.
#'
...
genome_scan_module_spec <- function() {
  new_analysis_module_spec(
    ...
    description = "Sliding-window FST and diversity scans",
