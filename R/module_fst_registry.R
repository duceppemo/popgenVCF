...
#' measure, Weir and Goudet's (2017) population-specific FST (beta), Nei's
#' (1987) Dxy absolute divergence, output schema, and population-metadata
#' requirements.
#'
...
fst_module_spec <- function() {
  new_analysis_module_spec(
    ...
    description = "Global and pairwise Weir-Cockerham FST, Nm, Jost's D, Dxy, and population-specific FST",
    validate = validate_fst_result,
    outputs = c("fst", "fst_ci"),
    references = c("Weir and Cockerham 1984", "Wright 1931", "Jost 2008", "Weir and Goudet 2017", "Nei 1987"),
