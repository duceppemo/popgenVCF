...
> Development series: **1.0.6** — active development on `main` toward
> the next release, past the current stable release **1.0.5** (released
> 2026-08-26; Zenodo DOI reconciliation still pending, as is 1.0.3's/1.0.4's).
