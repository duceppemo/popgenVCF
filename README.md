...
<p align="center">
  ...
  <a href="https://doi.org/10.5281/zenodo.22848587"><img alt="DOI" src="https://img.shields.io/badge/DOI-10.5281%2Fzenodo.22848587-blue.svg"></a>
</p>
...
> Development series: **1.0.15.9000** — active development on `main` toward
> the next release, past the current stable release **1.0.15** (released
> 2026-09-19; [DOI 10.5281/zenodo.22848587](https://doi.org/10.5281/zenodo.22848587)).
...
Edit `analysis.yml` to use container paths such as `/data/cohort.vcf.gz` (see the Configuration
Reference's [Input](https://github.com/duceppemo/popgenVCF/wiki/Configuration-Reference#input)/[Output](https://github.com/duceppemo/popgenVCF/wiki/Configuration-Reference#output) sections), then run:
...
1.0.15 is archived on Zenodo at
[10.5281/zenodo.22848587](https://doi.org/10.5281/zenodo.22848587)
