...
> Development series: **1.0.4** — active development on `main` toward
> the next release, past the current stable release **1.0.3** (released
> 2026-08-25; Zenodo DOI reconciliation for this release is still pending).
