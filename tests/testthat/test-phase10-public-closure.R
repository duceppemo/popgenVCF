test_that("Phase 10.1 public surface is complete and deterministic", {
  ...
  audit_a <- phase10_1_audit_public_surface()
  audit_b <- phase10_1_audit_public_surface()
...
test_that("Phase 10.1 audit rejects registry drift", {
  ...
  expect_error(
    phase10_1_audit_public_surface(descriptor = descriptor),
    "does not match"
  )
})

test_that("Phase 10.1 closure evidence is deterministic and fail closed", {
  closure_a <- phase10_1_closure_evidence("ci::phase10.1::green")
  closure_b <- phase10_1_closure_evidence("ci::phase10.1::green")
  ...
  blocked <- phase10_1_closure_evidence(
    "ci::phase10.1::green",
...
test_that("Phase 10.1 closure detects tampering and renders a report", {
  closure <- phase10_1_closure_evidence("ci::phase10.1::green")
  report <- phase10_1_closure_report(closure)
  ...
  expect_error(
    phase10_1_closure_report(closure),
