...
test_that("the default registry is fully descriptor-driven", {
  ...
  expected <- c(
    ...
    "population_assignment", "fst", "genome_scan", "pcadapt", "ld_decay", "ne_ld",
    "dapc", "amova", "clonality", "sexbias", "ibd", "spatial_autocorrelation", "admixture", "faststructure", "snmf", "chromosome"
  )
