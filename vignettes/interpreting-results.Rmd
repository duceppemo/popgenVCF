...
The figures below are from a real ADMIXTURE run against the quickstart example (K=2..9, 5-fold cross-validation each K) -- deliberately enabled just for this documentation, not part of the bundled dataset's default analysis.
