...
The repository retains human-editable environment specifications, Zenodo deposition metadata, and validation workflows. popgenVCF 0.10.0 was scientifically approved, released, and deposited to Zenodo on 2026-08-01 (DOI [10.5281/zenodo.21747548](https://doi.org/10.5281/zenodo.21747548); concept DOI [10.5281/zenodo.21747067](https://doi.org/10.5281/zenodo.21747067)); popgenVCF 1.0.0 followed the same process on 2026-08-23 (DOI [10.5281/zenodo.22069452](https://doi.org/10.5281/zenodo.22069452), same concept DOI); these software contracts continue to govern every subsequent release the same way.
